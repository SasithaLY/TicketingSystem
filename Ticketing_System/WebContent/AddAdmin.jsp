...
<div class="container">
  ...
  <form action="${pageContext.request.contextPath}/UserController?action=ADMIN" class="was-validated" method="POST">
  
    <div class="form-group">
      <label for="uname">Username: </label>
      <input type="text" class="form-control" value="${user.username}" id="uname" placeholder="Enter username" name="uname" required>

    </div>
    
    <div class="form-group">
      <label for="pwd">Password: </label>
      <input type="password" class="form-control" value="${user.password}" id="pwd" placeholder="Enter password" name="pwd" required>
